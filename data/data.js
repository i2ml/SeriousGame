var situations =
    {
        1:
            {
                "enonce": "Il est 13h00, Arthur sort de table. Après son fromage, il lui reste une petite place pour un dessert. Penché au dessus de son frigo, il hésite entre plusieurs options : ",
                "arguments": {
                    "1": {
        ...
        2: {
            ...
            "arguments": {
                ...
                "5": {
                    "enonce": "Formule du jour : (terrine de campagne, entrecôte frites sauce roquefort, panna cotta).",
                    "energieNeeded": 0,
                    "success": {
        ...
        3: {
            ...
            "arguments": {
                ...
                "3": {
                    "enonce": "La diététicienne lui apprend que le lait de brebis est plus simple à digérer, il n'est pas sûr d'aimer, mais il suit ses conseils.",
                    "energieNeeded": 0,
                    "success": {
        ...
        6: {
            ...
            "arguments": {
                ...
                "3": {
                    "enonce": "De l’huile d’olive extra.",
                    "energieNeeded": 0,
                    "success": {
                ...
                "4": {
                    "enonce": "De l’huile de tournesol raffinée bio.",
                    "energieNeeded": 0,
                    "success": {
                ...
                "5": {
                    "enonce": "De l’huile de tournesol non raffinée bio.",
                    "energieNeeded": 0,
                    "success": {
        ...
        7: {
            "enonce": "Arthur est dans son supermarché et achète du steak haché pour dîner. À cause de sa conjonctivite, il n’arrive pas à lire correctement les étiquettes et ne sait pas lequel choisir...",
            "arguments": {
                "1": {
                    "enonce": "Il sort son téléphone avec une appli qui lit les étiquettes à sa place.",
                    "energieNeeded": 0,
                    "success": {
                ...
                "4": {
                    "enonce": "Il prend un haché premier prix.",
                    "energieNeeded": 0,
                    "success": {
        ...
        9: {
            ...
            "arguments": {
                "1": {
                    "enonce": "Il accepte de prendre une viennoiserie, il ne faut pas vexer son client.",
                    "energieNeeded": 0,
                    "success": {
                ...
                "2": {
                    "enonce": "Il refuse la viennoiserie, mais accepte un fruit et des oléagineux.",
                    "energieNeeded": 0,
                    "success": {
                ...
                "5": {
                    "enonce": "Elles sont vraiment bonnes ces viennoiseries, j’en prends une seconde.",
                    "energieNeeded": 0,
                    "success": {
        ...
        10: {
            ...
            "arguments": {
                ...
                "4": {
                    "enonce": "Il se fait livrer un bon repas de traiteur à domicile !",
                    "energieNeeded": 0,
                    "success": {
                ...
                "5": {
                    "enonce": "Il décide de se rabattre sur de la restauration rapide (Mc Donald / Quick)",
                    "energieNeeded": 0,
                    "success": {
        ...
        12: {
            ...
            "arguments": {
                ...
                "3": {
                    "enonce": "Haricots verts, petits pois, épinards, courgettes, poivrons, tomate, carottes",
                    "energieNeeded": 0,
                    "success": {
